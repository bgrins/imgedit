(function(A, w) {
  ...
  function oa(a) {
    var b, d = [], f = [], e = arguments, i, j, o, k, n, r;
    j = c.data(this, "events");
    if(!(a.liveFired === this || !j || !j.live || a.button && a.type === "click")) {
      a.liveFired = this;
      var u = j.live.slice(0);
      for(k = 0;k < u.length;k++) {
        j = u[k];
        j.origType.replace(O, "") === a.type ? f.push(j.selector) : u.splice(k--, 1)
      ...
      for(r = d.length;n < r;n++) {
        ...
        if(i.handleObj.origHandler.apply(i.elem, e) === false) {
          b = false;
          break
        }
      }return b
  ...
  c.fn.extend({attr:function(a, b) {
    ...
    if(c.isFunction(a)) {
      ...
      for(var b = (a || "").split(ca), d = 0, f = this.length;d < f;d++) {
        ...
        if(e.nodeType === 1) {
          if(e.className) {
            for(var i = " " + e.className + " ", j = e.className, o = 0, k = b.length;o < k;o++) {
              if(i.indexOf(" " + b[o] + " ") < 0) {
                j += " " + b[o]
              }
    ...
    if(c.isFunction(a)) {
      ...
      for(var b = (a || "").split(ca), d = 0, f = this.length;d < f;d++) {
        ...
        if(e.nodeType === 1 && e.className) {
          if(a) {
            for(var i = (" " + e.className + " ").replace(Aa, " "), j = 0, o = b.length;j < o;j++) {
              i = i.replace(" " + b[j] + " ", " ")
    ...
    if(c.isFunction(a)) {
      ...
      if(d === "string") {
        for(var e, i = 0, j = c(this), o = b, k = a.split(ca);e = k[i++];) {
          o = f ? o : !j.hasClass(e);
  ...
  c.event = {add:function(a, b, d, f) {
    if(!(a.nodeType === 3 || a.nodeType === 8)) {
      ...
      if(d.handler) {
        ...
        var j = i.events = i.events || {}, o = i.handle;
        if(!o) {
          i.handle = o = function() {
        ...
        for(var k, n = 0, r;k = b[n++];) {
          i = e ? c.extend({}, e) : {handler:d, data:f};
          if(k.indexOf(".") > -1) {
            r = k.split(".");
            k = r.shift();
            i.namespace = r.slice(0).sort().join(".")
          }else {
            r = [];
            i.namespace = ""
          }i.type = k;
          i.guid = d.guid;
          var u = j[k], z = c.event.special[k] || {};
          if(!u) {
            u = j[k] = [];
    ...
    if(!(a.nodeType === 3 || a.nodeType === 8)) {
      var e, i = 0, j, o, k, n, r, u, z = c.data(a), C = z && z.events;
      if(z && C) {
        if(b && b.type) {
          d = b.handler;
          b = b.type
    ...
    try {
      ...
      if(!a.isDefaultPrevented()) {
        f = a.target;
        var j, o = c.nodeName(f, "a") && e === "click", k = c.event.special[e] || {};
  ...
  c.each(["bind", "one"], function(a, b) {
    c.fn[b] = function(d, f, e) {
      if(typeof d === "object") {
        ...
        e = f;
        f = w
      }var j = b === "one" ? c.proxy(e, function(k) {
        c(this).unbind(k, j);
  ...
  c.each(["live", "die"], function(a, b) {
    c.fn[b] = function(d, f, e, i) {
      var j, o = 0, k, n, r = i || this.selector, u = i ? this : c(this.context);
      if(c.isFunction(f)) {
        e = f;
        f = w
      }for(d = (d || "").split(" ");(j = d[o++]) != null;) {
        i = O.exec(j);
        k = "";
        if(i) {
          k = i[0];
          ...
          if(j === "focus" || j === "blur") {
            ...
            c.event.add(this, pa(j, r), {data:f, selector:r, handler:e, origType:j, origHandler:e, preType:n})
          }) : u.unbind(pa(j, r), e)
        }
      }return this
    }
  ...
  (function() {
    ...
    var n = k.selectors = {order:["ID", "NAME", "TAG"], match:{ID:/#((?:[\w\u00c0-\uFFFF-]|\\.)+)/, CLASS:/\.((?:[\w\u00c0-\uFFFF-]|\\.)+)/, NAME:/\[name=['"]*((?:[\w\u00c0-\uFFFF-]|\\.)+)['"]*\]/, ATTR:/\[\s*((?:[\w\u00c0-\uFFFF-]|\\.)+)\s*(?:(\S?=)\s*(['"]*)(.*?)\3|)\s*\]/, TAG:/^((?:[\w\u00c0-\uFFFF\*-]|\\.)+)/, CHILD:/:(only|nth|last|first)-child(?:\((even|odd|[\dn+-]*)\))?/, POS:/:(nth|eq|gt|lt|first|last|even|odd)(?:\((\d*)\))?(?=[^-]|$)/, PSEUDO:/:((?:[\w\u00c0-\uFFFF-]|\\.)+)(?:\((['"]?)((?:\([^\)]+\)|[^\(\)]*)+)\2\))?/}, 
  ...
  if(!c.support.htmlSerialize) {
    ...
    var e, i, j = a[0], o = [], k;
    if(!c.support.checkClone && arguments.length === 3 && typeof j === "string" && ua.test(j)) {
      return this.each(function() {
      ...
      k = e.fragment;
      if(i = k.childNodes.length === 1 ? (k = k.firstChild) : k.firstChild) {
        b = b && c.nodeName(i, "tr");
        for(var n = 0, r = this.length;n < r;n++) {
          d.call(b ? f(this[n], i) : this[n], n > 0 || e.cacheable || this.length > 1 ? k.cloneNode(true) : k)
        }
  ...
  c.extend({clean:function(a, b, d, f) {
    ...
    if(typeof b.createElement === "undefined") {
    ...
    }for(var e = [], i = 0, j;(j = a[i]) != null;i++) {
      if(typeof j === "number") {
        j += ""
      }if(j) {
        if(typeof j === "string" && !jb.test(j)) {
          j = b.createTextNode(j)
        }else {
          if(typeof j === "string") {
            j = j.replace(Ka, Ma);
            var o = (La.exec(j) || ["", ""])[1].toLowerCase(), k = F[o] || F._default, n = k[0], r = b.createElement("div");
            for(r.innerHTML = k[1] + j + k[2];n--;) {
              r = r.lastChild
            }if(!c.support.tbody) {
              n = ib.test(j);
            ...
            }!c.support.leadingWhitespace && V.test(j) && r.insertBefore(b.createTextNode(V.exec(j)[0]), r.firstChild);
            j = r.childNodes
          }
        }if(j.nodeType) {
          e.push(j)
      ...
      for(i = 0;e[i];i++) {
        if(f && c.nodeName(e[i], "script") && (!e[i].type || e[i].type.toLowerCase() === "text/javascript")) {
          f.push(e[i].parentNode ? e[i].parentNode.removeChild(e[i]) : e[i])
        }else {
          e[i].nodeType === 1 && e.splice.apply(e, [i + 1, 0].concat(c.makeArray(e[i].getElementsByTagName("script"))));
          d.appendChild(e[i])
        }
      }
    }return e
  }, cleanData:function(a) {
    for(var b, d, f = c.cache, e = c.event.special, i = c.support.deleteExpando, j = 0, o;(o = a[j]) != null;j++) {
      if(d = o[c.expando]) {
        b = f[d];
        if(b.events) {
  ...
  c.fn.extend({load:function(a, b, d) {
    ...
    c.ajax({url:a, type:f, dataType:"html", data:b, complete:function(j, o) {
      if(o === "success" || o === "notmodified") {
        i.html(e ? c("<div />").append(j.responseText.replace(tb, "")).find(e) : j.responseText)
      }d && i.each(d, [j.responseText, o, j])
    }});
    return this
  }, serialize:function() {
  ...
  c.extend({get:function(a, b, d, f) {
    ...
    function b() {
      e.success && e.success.call(k, o, j, x);
      e.global && f("ajaxSuccess", [x, e])
    }
    function d() {
      e.complete && e.complete.call(k, x, j);
    ...
    var e = c.extend(true, {}, c.ajaxSettings, a), i, j, o, k = a && a.context || e, n = e.type.toUpperCase();
      ...
      var g = x.onreadystatechange = function(q) {
        if(!x || x.readyState === 0 || q === "abort") {
          ...
          if(!E && x && (x.readyState === 4 || q === "timeout")) {
            E = true;
            x.onreadystatechange = c.noop;
            j = q === "timeout" ? "timeout" : !c.httpSuccess(x) ? "error" : e.ifModified && c.httpNotModified(x, e.url) ? "notmodified" : "success";
            var p;
            if(j === "success") {
              try {
    ...
    function d(j, o) {
      if(c.isArray(o)) {
        c.each(o, function(k, n) {
          b || /\[\]$/.test(j) ? f(j, n) : d(j + "[" + (typeof n === "object" || c.isArray(n) ? k : "") + "]", n)
        })
      }else {
    ...
    function f(j, o) {
      ...
      e[e.length] = encodeURIComponent(j) + "=" + encodeURIComponent(o)
    }
    var e = [];
    if(b === w) {
  ...
  c.fn.extend({show:function(a, b) {
    ...
    if(c.isEmptyObject(a)) {
      ...
      var i = c.extend({}, e), j, o = this.nodeType === 1 && c(this).is(":hidden"), k = this;
      for(j in a) {
        var n = j.replace(ia, ja);
        if(j !== n) {
          a[n] = a[j];
          delete a[j];
          j = n
  ...
  if(c.expr && c.expr.filters) {
    ...
    for(var k = b.offsetTop, n = b.offsetLeft;(b = b.parentNode) && b !== o && b !== j;) {
      ...
      if(b === d) {
        ...
        if(c.offset.doesNotAddBorder && !(c.offset.doesAddBorderForTableAndCells && /^t(able|d|h)$/i.test(b.nodeName))) {
          k += parseFloat(i.borderTopWidth) || 0;
      ...
      k += Math.max(j.scrollTop, o.scrollTop);
  ...
  c.each(["Left", "Top"], function(a, b) {
    ...
    c.fn[d] = function(f) {
      ...
      if(!e) {
        return null
      }return f !== w ? this.each(function() {
        if(i = wa(this)) {
          i.scrollTo(!a ? f : c(i).scrollLeft(), a ? f : c(i).scrollTop())
        }else {
          this[d] = f
        }
      }) : (i = wa(e)) ? "pageXOffset" in i ? i[a ? "pageYOffset" : "pageXOffset"] : c.support.boxModel && i.document.documentElement[d] || i.document.body[d] : e[d]
    }
  });
